    ...
    public partial class freshstart : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Assigned_ProjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectMembers_Projects_Assigned_ProjectId",
                        column: x => x.Assigned_ProjectId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskProjects_ProjectMembers_ProjectMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_Assigned_ProjectId",
                table: "ProjectMembers",
                column: "Assigned_ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskProjects_ProjectMemberId",
                table: "TaskProjects",
